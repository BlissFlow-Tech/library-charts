...
| gateways | object | `{"public":{"className":"cilium","enabled":false,"listeners":[{"hostname":"app.example.com"}]}}` | Gateway api configuration - support multiple gateway |
...
| httproutes | object | `{"frontend":{"enabled":"fales","gatewayName":"public","hostnames":["app.example.com"]}}` | Gateway httproute configuration -  support multiple httproutes |
...
| vpas.default.annotations.test | string | `"test"` |  |
| vpas.default.enabled | bool | `false` |  |
| vpas.default.resourcePolicy.containerPolicies[0].containerName | string | `"*"` |  |
| vpas.default.resourcePolicy.containerPolicies[0].controlledResources[0] | string | `"cpu"` |  |
| vpas.default.resourcePolicy.containerPolicies[0].controlledResources[1] | string | `"memory"` |  |
| vpas.default.resourcePolicy.containerPolicies[0].maxAllowed.cpu | int | `2` |  |
| vpas.default.resourcePolicy.containerPolicies[0].maxAllowed.memory | string | `"2Gi"` |  |
| vpas.default.resourcePolicy.containerPolicies[0].minAllowed.cpu | string | `"100m"` |  |
| vpas.default.resourcePolicy.containerPolicies[0].minAllowed.memory | string | `"128Mi"` |  |
| vpas.default.targetRef.kind | string | `"Deployment"` |  |
| vpas.default.updatePolicy.updateMode | string | `"Auto"` |  |
